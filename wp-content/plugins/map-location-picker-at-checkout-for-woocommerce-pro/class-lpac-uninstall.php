...
class Lpac_Uninstall {
	...
	public static function remove_plugin_settings() {
		...
		$option_keys = array(
			...
			'lpac_enable_use_store_selector_as_origin',
			...
			'lpac_subtract_free_shipping_distance',
			...
			'lpac_enable_shipping_restrictions',
			'lpac_enable_shipping_restrictions_local_pickup',
			...
			'lpac_enable_free_shipping_for_regions',
			...
			'lpac_cost_by_store_location_taxable',
			// Misc
			...
			'lpac_migrated__cost_by_distance_standard',
			'lpac_migrated__add_should_calculate_per_distance_unit_field',
			'lpac_migrated__add_address_to_store_locations',
			'lpac_migrated__enabled_shipping_restrictions_option',
			'kikote_migrated__store_locations_shipping_method',
		);
