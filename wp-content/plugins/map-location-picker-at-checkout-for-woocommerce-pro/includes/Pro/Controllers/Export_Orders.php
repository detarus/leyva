...
class Export_Orders {
	 ...
	 * @return void
	 */
	public function getOrderRecordsAjaxHandler() {
		...
		try {
			...
			$link = ( new Export_Orders_Model() )->getCsvLink( $date_range );
	 ...
	 * @return void
	 */
	public function getOrdersByRangeAjaxHandler() {
		...
		try {
			...
			$orders = ( new Export_Orders_Model() )->getOrdersByRange( $date_range );
