...
class CostByDistance {
	...
	private function setCostByDistanceStandard( array $rates, $package ) : array {
		...
		if ( Shipping_Settings::limit_shipping_distance() && ! empty( $max_shipping_distance ) && get_option( 'lpac_enable_cost_by_distance_range' ) !== 'yes' ) {
		...
		foreach ( $rates as $rate ) {
			...
			if ( in_array( $shipping_method_id, $allowed_shipping_method_ids ) ) {
				...
				*/
				...
				if ( Shipping_Settings::substract_free_shipping_distance() === false ) {
