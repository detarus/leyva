...
class Admin_Settings {
	...
	public static function create_shipping_settings_fields() {
		...
		$lpac_pro_settings[] = array(
			'name' => __( 'Shipping', 'map-location-picker-at-checkout-for-woocommerce' ),
			'id'   => 'lpac_shipping_settings',
			'type' => 'title',
			'desc' => Lite_Admin_Settings::create_plugin_settings_banner() . '<p style="text-align:center; font-size: 20px; font-weight: bold;">' . __( 'Enabling multiple shipping workflows can lead to unexpected shipping costs and behavior. Be sure to test your setup if you enable more than one.', 'map-location-picker-at-checkout-for-woocommerce' ) . '</p>',
		);
