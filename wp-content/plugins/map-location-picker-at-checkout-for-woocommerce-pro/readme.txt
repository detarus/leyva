...
For this plugin to work, you need to **delete all contents of that blocks page** and add the shortcode: `[woocommerce_checkout]` inside it. You can see this link for reverting to classic checkout [WooCommerce doc](https://woo.com/document/cart-checkout-blocks-status/#section-6) 

Once thats done you'll have the normal WooCommerce checkout page and the plugin options will show. Still need help? Submit a support request [here](https://lpacwp.com/contact).
...
- Option to turn on Places Autocomplete(Google Autofill) feature. [Learn More](https://lpacwp.com/docs/places-autocomplete-feature/)
...
- Checkout our Blog: [Here >>>](https://lpacwp.com/blog?utm_source=wp.org&utm_medium=readme&utm_campaign=blog-promo)
- Take a look at our other plugin to help further manage your store by adding a checkout calendar so customers can select the order Date and Time during checkout: Delivery & Pickup Scheduling for WooCommerce [Here >>>](https://dpswp.com)
- Checkout [Printus](https://printus.cloud), a remote cloud printing plugin for WooCommerce that automatically prints your orders as soon as they come in [Here >>>](https://printus.cloud).
...
Ensure that you have setup the plugin with your API key by going to WordPress Dashboard->WooCommerce->Location Picker At Checkout. See [this doc](https://lpacwp.com/docs/getting-your-google-maps-api-key/) for getting your API key. 
...
This message shows when you have not finished setting up the map correctly inside the Google Cloud Console. Please make sure you've followed all the steps from the [setup guide](https://lpacwp.com/docs/getting-your-google-maps-api-key/) including the "Setting up Billing & Google Monthly Credit" section.

= Map shows "Oops! Something went wrong." =

This is usually shown when the domain you restricted inside google cloud console is wrong. Make sure you've restricted the correct domain. [See here for instructions](https://lpacwp.com/docs/getting-your-google-maps-api-key/#important-restricting-your-api-key). 

This message shows when you have not finished setting up the map correctly inside the Google Cloud Console. Please make sure you've followed all the steps from the [setup guide](https://lpacwp.com/docs/getting-your-google-maps-api-key/) including the "Setting up Billing & Google Monthly Credit" section.

= Do I need to pay to use this plugin? =

No! The plugin is free to use. The Google Maps APIs it uses, however, do require you to setup an account on Google's Cloud Console. The process is easy and requires you also attaching a billing method to your account. Google provides a $200 monthly credit for usage of their APIs so you don't have to worry about paying anything unless you receive alot of orders on your store (upwards of 15,000 orders in a month). See [this step](https://lpacwp.com/docs/getting-your-google-maps-api-key/#important-setting-up-billing--google-monthly-credit) in the setup guide for more details about how this works.
...
* [Improvement] Made it possible to change which places autocomplete field gets mapped to the checkout fields, using for  with filters. [Learn more](https://lpacwp.com/docs/how-to-change-places-autocomplete-selected-api-fields/).
* [Improvement] Added extra arg to `kikote_distance_range_shipping_cost` filter.
* [Info] Tested on WC 8.0.
* [Info] Tested on WP 6.3.

= 1.8.5 =
* [Improvement] Remove Delivery & Pickup Scheduling plugin related JS logic since Kikote Visibility Rules can take care of it.
* [Dev] Updated Freemius SDK.
...
* [Info] Read the release post [here](https://lpacwp.com/blog/kikote-location-picker-at-checkout-for-woocommerce-update-v1-8-2/).
* [Dev] Updated Freemius SDK.

= 1.8.1 =
* [Fix PRO] Subtract free shipping distance feature was returning wrong calculation at times.
* [Improvement] Bail Kikote visibility workflow when [Delivery & Pickup Scheduling plugin](https://wordpress.org/plugins/delivery-and-pickup-scheduling-for-woocommerce/) is controlling map visibility.
...
* [Info] Read the release post [here](https://lpacwp.com/blog/kikote-location-picker-at-checkout-for-woocommerce-update-v1-8-0/).
...
* [New PRO] Option to add an autocomplete seachbox inside the map display on the checkout page. [Learn more](https://lpacwp.com/docs/places-autocomplete-feature/#show-a-searchbox-inside-the-map)
...
= 1.6.13 =
* [New] Added an option to force the use of the Places AutoComplete feature. Please [read here for more details](https://lpacwp.com/docs/places-autocomplete-feature/#force-use-of-autocomplete-feature).
...
= 1.6.6 = 
* [New PRO] Cost by Distance Range feature. [Learn more](https://lpacwp.com/docs/shipping/#cost-by-distance-range)
...
* [Compatibility] Add AutoComplete support for Fluid Checkout plugin.
...
* [Compatibility] Support added for Fluid Checkout for WooCommerce plugin's custom checkout page.

= 1.5.2 = 
* [New PRO] Feature to prevent shipping to customers who's location do not fall inside your drawn shipping regions. [Learn More](https://lpacwp.com/docs/shipping/#cost-by-region)
* [New PRO] Feature to prevent shipping to customers who's location is beyond your maximum set shipping distance. [Learn More](https://lpacwp.com/docs/shipping/#cost-by-distance)
...
* [Info] Static Maps require enabling of an extra Google Map API endpoint. [Please see here for instructions](https://lpacwp.com/docs/enabling-google-static-map-api/).

= 1.3.5 =
* [New] Added Places Autocomplete feature [Learn More](https://lpacwp.com/docs/places-autocomplete-feature/). 
* [New] New option in General Settings to allow plugin to immediately request the customer location on checkout page load.  [Learn More](https://lpacwp.com/docs/general-settings/#detect-customer-location-on-checkout-page-load). 
