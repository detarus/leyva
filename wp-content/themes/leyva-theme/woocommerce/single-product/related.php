...
if ($related_products) : ?>
	...
	<section class="related products wc-related-products">
		<?php
		...
		<?php woocommerce_product_loop_start(); ?>
			<div class="<?php if(count($related_products) < 6) echo 'product-small-swiper'; else echo 'product-home-swiper'?> swiper">
