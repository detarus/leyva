...
if ($upsells) : ?>
	...
	<section class="up-sells upsells products wc-related-products">
		<?php
		...
		<?php woocommerce_product_loop_start(); ?>
			<div class="<?php if(count($upsells) < 6) echo 'product-small-swiper'; else echo 'product-home-swiper'?> swiper">
